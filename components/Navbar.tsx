...
const navItems = [
  ...
  },
  {
    ...
    href: '/strandar',
    submenu: [
      { text: 'Norra Mallorca', href: '/strandar?region=Norr' },
      { text: 'Östra Mallorca', href: '/strandar?region=Öst' },
      { text: 'Södra Mallorca', href: '/strandar?region=Syd' },
      { text: 'Västra Mallorca', href: '/strandar?region=Nordväst' },
      { text: 'Sydvästra Mallorca', href: '/strandar?region=Sydväst' },
