...
const städer = [
  { namn: 'Palma de Mallorca', href: '/palma-de-mallorca', region: 'Sydväst', beskrivning: 'Öns pulserande huvudstad med La Seu-katedralen, gamla stan och livlig restaurangscen', bild: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&q=80', tips: 'Bästa utsikten från Bellver slott' },
  ...
  { namn: 'Santanyi', href: '/santanyi', region: 'Syd', beskrivning: 'Charmig marknadsby känd för onsdagsmarknaden och närheten till Cala Llombards', bild: 'https://images.unsplash.com/photo-1516483638261-f4dbaf036963?w=600&q=80', tips: 'Onsdagsmarknaden är bättre än lördagen' },
  { namn: 'Porto Petro', href: '/porto-petro', region: 'Syd', beskrivning: 'Exklusiv och lugn marinaby i sydost, populär bland segelbåtar', bild: 'https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?w=600&q=80', tips: 'Perfekt för kvällspromenad längs hamnen' },
  ...
  { namn: 'Sineu', href: '/byar', region: 'Inland', beskrivning: 'Mallorcas geografiska hjärta med öns äldsta marknad sedan 1306', bild: 'https://images.unsplash.com/photo-1555881400-74d7acaacd8b?w=600&q=80', tips: 'Onsdagsmarknaden – kom tidigt för bästa upplevelsen' },
  { namn: 'Artà', href: '/byar', region: 'Öst', beskrivning: 'Historisk bergsstad med imponerande borg och vackra gränder', bild: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&q=80', tips: 'Besök borgen Santuari de Sant Salvador' },
  { namn: 'Felanitx', href: '/byar', region: 'Öst', beskrivning: 'Traditionell stad känd för keramik, vin och söndagsmarknad', bild: 'https://images.unsplash.com/photo-1516483638261-f4dbaf036963?w=600&q=80', tips: 'Köp lokal keramik direkt från hantverkarna' },
  { namn: 'Manacor', href: '/byar', region: 'Öst', beskrivning: 'Mallorcas näst största stad – känd för pärlor, möbler och Rafael Nadal', bild: 'https://images.unsplash.com/photo-1555881400-74d7acaacd8b?w=600&q=80', tips: 'Besök en pärlafabrik och se hur de tillverkas' },
  { namn: 'Inca', href: '/byar', region: 'Inland', beskrivning: 'Läderstaden med berömd torsdagsmarknad och källarviner', bild: 'https://images.unsplash.com/photo-1555993539-1732b0258235?w=600&q=80', tips: 'November – kom på den stora lädermässan' },
  ...
  { namn: 'Andratx', href: '/byar', region: 'Sydväst', beskrivning: 'Lugn stadskärna i sydväst nära Port d\'Andratx med fin marina', bild: 'https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?w=600&q=80', tips: 'Port d Andratx har öns snyggaste marina' },
  ...
  { namn: 'Llucmajor', href: '/byar', region: 'Syd', beskrivning: 'Historisk stad med medeltida rötter och vackert torg', bild: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&q=80', tips: 'Prova den lokala ensaimadan på torgets café' },
];
