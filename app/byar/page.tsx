...
const städer = [
  ...
  { namn: 'Sóller', href: '/soller', region: 'Nordväst', beskrivning: 'Bergsby omgiven av apelsinlundar med historisk spårvagn ner till havet', bild: 'https://images.unsplash.com/photo-4x9BFmS13p0?w=600&q=75', tips: 'Ta spårvagnen till Port de Sóller', top3: ['Historiska spårvagnen', 'Apelsinlundarna', 'Firó-festivalen i maj'] },
  ...
  { namn: 'Valldemossa', href: '/valldemossa', region: 'Nordväst', beskrivning: 'UNESCO-skyddad bergsby känt för Chopin och George Sands vistelse', bild: 'https://images.unsplash.com/photo-mDkMJzvDQgw?w=600&q=75', tips: 'Besök kartusianerklostret tidigt på morgonen', top3: ['Kartusianerklostret', 'Chopins pianosalong', 'Utsikten från byplatsen'] },
