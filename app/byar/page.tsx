...
const städer = [
  ...
  { namn: 'Deià', href: '/byar', region: 'Nordväst', beskrivning: 'Konstnärsby i Tramuntana-bergen med bohemisk atmosfär och havsutsikt', bild: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=600&q=80', tips: 'Robert Graves museum är ett måste' },
  { namn: 'Artà', href: '/byar', region: 'Öst', beskrivning: 'Historisk bergsstad med imponerande borg och vackra gränder', bild: 'https://images.unsplash.com/photo-1474722883778-792e7990302f?w=600&q=80', tips: 'Besök borgen Santuari de Sant Salvador' },
  { namn: 'Andratx', href: '/byar', region: 'Sydväst', beskrivning: "Lugn stadskärna i sydväst nära Port d'Andratx med fin marina", bild: 'https://images.unsplash.com/photo-1559827291-72ee739d0d9a?w=600&q=80', tips: "Port d'Andratx har öns snyggaste marina" },
  ...
  { namn: 'Sineu', href: '/byar', region: 'Inland', beskrivning: 'Mallorcas geografiska hjärta med öns äldsta marknad sedan 1306', bild: 'https://images.unsplash.com/photo-1548013146-72479768bada?w=600&q=80', tips: 'Onsdagsmarknaden – kom tidigt för bästa upplevelsen' },
  ...
  { namn: 'Manacor', href: '/byar', region: 'Öst', beskrivning: 'Mallorcas näst största stad – känd för pärlor, möbler och Rafael Nadal', bild: 'https://images.unsplash.com/photo-1555993539-1732b0258235?w=600&q=80', tips: 'Besök en pärlafabrik och se hur de tillverkas' },
  ...
  { namn: 'Capdepera', href: '/byar', region: 'Öst', beskrivning: 'Medeltida borg och pittoresk by i nordöst med panoramautsikt över havet', bild: 'https://images.unsplash.com/photo-1559519529-0936e4058364?w=600&q=80', tips: 'Besök Castell de Capdepera i solnedgången' },
  { namn: 'Port de Sóller', href: '/byar', region: 'Nordväst', beskrivning: 'Charmig hamnby med en av Mallorcas vackraste vikar, nådd med historisk spårvagn', bild: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=600&q=80', tips: 'Ta den historiska spårvagnen från Sóller' },
  { namn: 'Campos', href: '/byar', region: 'Syd', beskrivning: 'Lantlig stad nära Es Trenc känd för salt, kapers och lördagsmarknad', bild: 'https://images.unsplash.com/photo-1533105079780-92b9be482077?w=600&q=80', tips: 'Perfekt stopp på väg till Es Trenc' },
];
