...
const städer = [
  ...
  { namn: 'Deià', href: '/deia', region: 'Nordväst', beskrivning: 'Konstnärsby i Tramuntana-bergen med bohemisk atmosfär och havsutsikt', bild: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=600&q=75', tips: 'Robert Graves museum är ett måste', top3: ['Robert Graves museum', 'Cala Deià (bad)', 'Utsikten från kyrkan'] },
