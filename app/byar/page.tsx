...
const städer = [
  { namn: 'Palma de Mallorca', href: '/palma-de-mallorca', region: 'Sydväst', beskrivning: 'Öns pulserande huvudstad med La Seu-katedralen, gamla stan och livlig restaurangscen', bild: 'https://images.unsplash.com/photo-1499678329028-101435549a02?w=1600&q=85', tips: 'Bästa utsikten från Bellver slott', top3: ['La Seu-katedralen', 'Gamla stan (Casc Antic)', 'Bellver Slott'] },
  ...
  { namn: 'Valldemossa', href: '/valldemossa', region: 'Nordväst', beskrivning: 'UNESCO-skyddad bergsby känt för Chopin och George Sands vistelse', bild: 'https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=1600&q=85', tips: 'Besök kartusianerklostret tidigt på morgonen', top3: ['Kartusianerklostret', 'Chopins pianosalong', 'Utsikten från byplatsen'] },
  ...
  { namn: 'Manacor', href: '/byar', region: 'Öst', beskrivning: 'Mallorcas näst största stad – känd för pärlor, möbler och Rafael Nadal', bild: 'https://images.unsplash.com/photo-1499678329028-101435549a02?w=1600&q=85', tips: 'Besök en pärlafabrik och se hur de tillverkas', top3: ['Majórica pärlafabrik', 'Rafa Nadal Academy', 'Måndagsmarknaden'] },
