...
const stränder = [
  ...
  { namn: 'Cala Millor', region: 'Öst', typ: 'Sandstrand', svårighet: 'Enkel', längd: '1,5 km', beskrivning: 'Populär turiststrand med fin gyllene sand, lugnt vatten och alla faciliteter. Blåflagg och bra för familjer.', tips: 'Nordliga delen av stranden är lugnare och mindre fullsatt', maps: 'https://maps.google.com/?q=Cala+Millor+Mallorca', bild: 'https://images.unsplash.com/photo-1593174898997-488a0443e852?w=600&q=80', familj: true, snorkling: false, nudist: false },
  { namn: 'Porto Cristo', region: 'Öst', typ: 'Sandstrand', svårighet: 'Enkel', längd: '350m', beskrivning: 'Skyddad stadsvik med gyllene sand och hamnanslutning. Perfekt utgångspunkt för Coves del Drach. Alla faciliteter.', tips: 'Kombinera med besök i de berömda drakgrottorna Coves del Drach', maps: 'https://maps.google.com/?q=Porto+Cristo+strand+Mallorca', bild: 'https://images.unsplash.com/photo-1606729734060-3d6de0048e43?w=600&q=80', familj: true, snorkling: false, nudist: false },
  { namn: 'Cala Tuent', region: 'Nordväst', typ: 'Vik', svårighet: 'Smal bergväg', längd: '150m', beskrivning: 'Vildromantisk vik vid foten av Tramuntana-bergen med dramatisk klipplandskap. Lugn och avskild med restaurang på plats.', tips: 'Smal och kurvig väg ned – ta det lugnt med bilen', maps: 'https://maps.google.com/?q=Cala+Tuent+Mallorca', bild: 'https://images.unsplash.com/photo-1734639403228-476663647bcf?w=600&q=80', familj: false, snorkling: true, nudist: false },
  ...
  { namn: 'Cala Estellencs', region: 'Nordväst', typ: 'Stenstrand', svårighet: 'Brant väg', längd: '50m', beskrivning: 'Liten stenstrand under Tramuntana-bergen med kristallklart vatten och dramatisk klippomgivning. Populär bland dykare.', tips: 'Brant, smal väg ned – belönas med fantastisk utsikt och klart vatten', maps: 'https://maps.google.com/?q=Cala+Estellencs+Mallorca', bild: 'https://images.unsplash.com/photo-1560243360-0eb6e88f0d08?w=600&q=80', familj: false, snorkling: true, nudist: false },
  { namn: 'Cala Xinxell', region: 'Sydväst', typ: 'Vik', svårighet: 'Enkel', längd: '80m', beskrivning: 'Lugn och undanskymd vik vid Illetas, populär bland lokalbefolkningen. Rena klippor och klart vatten utan turistmassor.', tips: 'Okänd pärla som undviker massturism – lokalbors favorit', maps: 'https://maps.google.com/?q=Cala+Xinxell+Illetas+Mallorca', bild: 'https://images.unsplash.com/photo-1734639403228-476663647bcf?w=600&q=80', familj: false, snorkling: true, nudist: false },
  { namn: 'Playa de Palma', region: 'Sydväst', typ: 'Sandstrand', svårighet: 'Enkel', längd: '5 km', beskrivning: 'Palmas stora stadsriviera med 5 km sandstrand, strandpromenad, restauranger och nöjesutbud. Pulserande atmosfär.', tips: 'Perfekt för dem som vill kombinera strand med stadsliv och nöjen', maps: 'https://maps.google.com/?q=Playa+de+Palma+Mallorca', bild: 'https://images.unsplash.com/photo-1593174898997-488a0443e852?w=600&q=80', familj: true, snorkling: false, nudist: false },
  { namn: 'Cala Canyamel', region: 'Öst', typ: 'Sandstrand', svårighet: 'Enkel', längd: '300m', beskrivning: 'Lugn sandstrand mellan Cala Ratjada och Cala Millor med vackra berg i bakgrunden. Lite mindre besökt än grannstränderna.', tips: 'Bra alternativ om Cala Millor känns för fullsatt', maps: 'https://maps.google.com/?q=Cala+Canyamel+Mallorca', bild: 'https://images.unsplash.com/photo-1606729734060-3d6de0048e43?w=600&q=80', familj: true, snorkling: false, nudist: false },
  { namn: 'Es Carbó', region: 'Syd', typ: 'Sandstrand', svårighet: 'Enkel', längd: '1 km', beskrivning: 'Lugn och rensatt sandstrand på södra Mallorca med turkost vatten och färre turister än grannstränder som Es Trenc.', tips: 'Bra alternativ till Es Trenc om du vill ha mer lugn och ro', maps: 'https://maps.google.com/?q=Es+Carbo+Mallorca', bild: 'https://images.unsplash.com/photo-1606729734060-3d6de0048e43?w=600&q=80', familj: true, snorkling: false, nudist: false },
  { namn: 'Port de Pollença', region: 'Norr', typ: 'Sandstrand', svårighet: 'Enkel', längd: '2 km', beskrivning: 'Lång smal sandstrand med lugnt vatten och vacker bergsutsikt. Charmig strandpromenad och livlig restaurangscen.', tips: 'Perfekt för morgonpromenad – en av öns bästa strandpromenader', maps: 'https://maps.google.com/?q=Port+de+Pollenca+strand+Mallorca', bild: 'https://images.unsplash.com/photo-1593174898997-488a0443e852?w=600&q=80', familj: true, snorkling: false, nudist: false },
  { namn: 'Cala Ferrera', region: 'Öst', typ: 'Sandstrand', svårighet: 'Enkel', längd: '200m', beskrivning: "En av de fem charmiga bukterna i Cala d'Or-området med fin sand och klart vatten. Lugn och familjevänlig.", tips: 'Mindre och mer intim än grannbukterna – bra för par', maps: 'https://maps.google.com/?q=Cala+Ferrera+Mallorca', bild: 'https://images.unsplash.com/photo-1608126313950-b17430292454?w=600&q=80', familj: true, snorkling: true, nudist: false },
  { namn: 'Cala Romantica', region: 'Öst', typ: 'Vik', svårighet: 'Enkel', längd: '100m', beskrivning: 'Vacker skyddad vik med klart vatten och tallskog runt om. Lugn atmosfär som passar för romantiska utflykter.', tips: 'Kom tidigt – den lilla parkeringen fylls snabbt på sommaren', maps: 'https://maps.google.com/?q=Cala+Romantica+Mallorca', bild: 'https://images.unsplash.com/photo-1734639403228-476663647bcf?w=600&q=80', familj: false, snorkling: true, nudist: false },
  { namn: 'Cala Sa Nau', region: 'Öst', typ: 'Vik', svårighet: 'Enkel', längd: '80m', beskrivning: "Pittoresk bukt nära Cala d'Or med riktigt klart vatten och fin sand. Populär bland snorklare och familjer.", tips: 'En av östkustens mest underskattade stränder', maps: 'https://maps.google.com/?q=Cala+Sa+Nau+Mallorca', bild: 'https://images.unsplash.com/photo-1734639403228-476663647bcf?w=600&q=80', familj: true, snorkling: true, nudist: false },
  { namn: 'Portal Vells', region: 'Sydväst', typ: 'Vik', svårighet: 'Grusväg', längd: '100m', beskrivning: 'Gömd strand utan hotell och turism – lokalbornas hemliga favorit. Gratis parkering, liten gratisparkering.', tips: 'Kom tidigt – liten gratisparkering. Nästan bara lokalbefolkning här.', maps: 'https://maps.google.com/?q=Portal+Vells+Mallorca', bild: 'https://images.unsplash.com/photo-1593174898997-488a0443e852?w=600&q=80', familj: false, snorkling: true, nudist: true },
  { namn: 'Cala Marçal', region: 'Öst', typ: 'Sandstrand', svårighet: 'Enkel', längd: '500m', beskrivning: 'Fin sandstrand nära Porto Colom med lugnt vatten och bra faciliteter. Barnvänlig och välorganiserad.', tips: 'Perfekt dagstrip från Porto Colom – ta med snorkelmask', maps: 'https://maps.google.com/?q=Cala+Marcal+Mallorca', bild: 'https://images.unsplash.com/photo-1593174898997-488a0443e852?w=600&q=80', familj: true, snorkling: true, nudist: false },
  ...
  { namn: 'Cala Bona', region: 'Öst', typ: 'Sandstrand', svårighet: 'Enkel', längd: '250m', beskrivning: 'Charmig strand med liten fiskehamn nära Cala Millor. Mer autentisk atmosfär än grannorten med lokala restauranger.', tips: 'Ät middag vid hamnen efter ett dopp – bättre restauranger än Cala Millor', maps: 'https://maps.google.com/?q=Cala+Bona+Mallorca', bild: 'https://images.unsplash.com/photo-1606729734060-3d6de0048e43?w=600&q=80', familj: true, snorkling: false, nudist: false },
];
        ...
        <div style={{ marginTop: '64px', paddingTop: '48px', borderTop: '1px solid #ede5da' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(min(300px,100%), 1fr))', gap: '20px' }}>
            <AffiliateCard
              ...
              bild="https://images.unsplash.com/photo-1593174898997-488a0443e852?w=600&q=75"
            />
            <AffiliateCard
              typ="aktivitet"
              ...
              bild="https://images.unsplash.com/photo-1734639403228-476663647bcf?w=600&q=75"
            />
            <AffiliateCard
              typ="transfer"
