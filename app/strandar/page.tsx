...
const stränder = [
  ...
  { namn: 'Cala Mesquida', region: 'Öst', typ: 'Sandstrand', svårighet: 'Enkel', längd: '350m', beskrivning: 'Vacker naturstrand i naturreservat nära Capdepera med vita sanddyner och tallskog. Extra populär bland surfare tack vare bra vågor.', tips: 'Parkering 100m från stranden – kom tidigt på helger', maps: 'https://maps.google.com/?q=Cala+Mesquida+Mallorca', bild: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=600&q=80', familj: true, snorkling: false, nudist: false },
