...
const stränder = [
  ...
  { namn: 'Cala Tuent', region: 'Nordväst', typ: 'Vik', svårighet: 'Smal bergväg', längd: '150m', beskrivning: 'Vildromantisk vik vid foten av Tramuntana-bergen med dramatisk klipplandskap. Lugn och avskild med restaurang på plats.', tips: 'Smal och kurvig väg ned – ta det lugnt med bilen', maps: 'https://maps.google.com/?q=Cala+Tuent+Mallorca', bild: 'https://images.unsplash.com/photo-1502126829-a3a29b2b72f7?w=600&q=80', familj: false, snorkling: true, nudist: false },
