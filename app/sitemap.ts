...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: { url: string; priority: number; changeFrequency: MetadataRoute.Sitemap[number]['changeFrequency'] }[] = [
    ...
    { url: `${baseUrl}/barn`, priority: 0.85, changeFrequency: 'monthly' },
    { url: `${baseUrl}/barn/vattenparker`, priority: 0.8, changeFrequency: 'monthly' },
    { url: `${baseUrl}/barn/djurparker-och-akvarier`, priority: 0.8, changeFrequency: 'monthly' },
    { url: `${baseUrl}/barn/inomhus-och-regn`, priority: 0.8, changeFrequency: 'monthly' },
