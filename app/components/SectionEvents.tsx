...
export const evenemang = [
  ...
  { namn: 'Aqualand El Arenal – Säsongsöppning', datum: 'Maj 2026', plats: 'El Arenal', kategori: 'Familj', beskrivning: 'Mallorcas populäraste vattenpark öppnar för sommarsäsongen med nya attraktioner', länk: 'https://www.aqualand.es', bild: 'https://images.unsplash.com/photo-1530870110042-98b2cb110834?w=600&q=80' },
  ...
  { namn: 'Hidropark Alcúdia', datum: 'Juni–september 2026', plats: 'Alcúdia', kategori: 'Familj', beskrivning: 'Populär vattenpark norr om Alcúdia med vattenrutschkanor och barnpooler', länk: 'https://www.hidropark.com', bild: 'https://images.unsplash.com/photo-1530870110042-98b2cb110834?w=600&q=80' },
  ...
  { namn: 'Marineland Mallorca', datum: 'Maj–oktober 2026', plats: 'Costa de Blanes', kategori: 'Familj', beskrivning: 'Delfinshow, pingviner och hajar – perfekt familjedag längs sydvästkusten', länk: 'https://www.marineland.es', bild: 'https://images.unsplash.com/photo-1551632811-561732d1e306?w=600&q=80' },
