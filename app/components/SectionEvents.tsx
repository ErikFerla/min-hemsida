...
export const evenemang = [
  ...
  { namn: 'PalmaVela Regatta', datum: 'Maj 2026', plats: 'Palma', kategori: 'Sport', beskrivning: 'Internationell segelregatta med tävlande från hela världen i Palmas vackra bukt', länk: 'https://www.google.com/search?q=PalmaVela+Regatta+Mallorca+2026', bild: 'https://images.unsplash.com/photo-1505118380757-91f5f5632de0?w=600&q=80' },
  ...
  { namn: 'Palma Marathon', datum: 'Oktober 2026', plats: 'Palma', kategori: 'Sport', beskrivning: 'Maratonlopp genom Palmas historiska gator och längs strandpromenaden', länk: 'https://www.google.com/search?q=Palma+Marathon+2026', bild: 'https://images.unsplash.com/photo-1452626038306-9aae5e071dd3?w=600&q=80' },
  { namn: 'Palma Boat Show', datum: 'November 2026', plats: 'Palma', kategori: 'Sport', beskrivning: 'Höstens stora båtmässa med lyxbåtar och marinautrustning', länk: 'https://www.google.com/search?q=Palma+Boat+Show+2026', bild: 'https://images.unsplash.com/photo-1567899378494-47b22a2ae96a?w=600&q=80' },
  ...
  // MUSIK
  { namn: 'Mallorca Live Festival', datum: '11–13 juni 2026', plats: 'Magaluf, Calvià', kategori: 'Musik', beskrivning: 'Mallorcas största musikfestival med 25 000 besökare och internationella toppakter', länk: 'https://www.mallorcalivefestival.com', bild: 'https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=600&q=80' },
  { namn: 'Danzû Festival', datum: 'Augusti 2026', plats: 'Magaluf', kategori: 'Musik', beskrivning: 'Elektronisk musikfestival med världsstjärnor som Carl Cox och Richie Hawtin', länk: 'https://www.google.com/search?q=Danzu+Festival+Mallorca+2026', bild: 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=600&q=80' },
  ...
  { namn: 'Nacht des Ballermanns', datum: 'Juli 2026', plats: 'Playa de Palma', kategori: 'Musik', beskrivning: 'Ballermanns stora sommarnatt med musik, dans och festligheter', länk: 'https://www.google.com/search?q=Ballermann+Mallorca+2026', bild: 'https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6c3?w=600&q=80' },
  ...
  { namn: 'Julkonserter i La Seu', datum: 'December 2026', plats: 'Palma', kategori: 'Musik', beskrivning: 'Stämningsfulla julkonserter i Palmas magnifika katedral La Seu', länk: 'https://www.google.com/search?q=julkonsert+La+Seu+Palma+2026', bild: 'https://images.unsplash.com/photo-1512389142860-9c449e58a543?w=600&q=80' },
  // KULTUR
  { namn: 'Semana Santa – Påskveckan', datum: 'April 2026', plats: 'Hela ön', kategori: 'Kultur', beskrivning: 'Högtidliga processioner med levande ljus och traditionell musik genom gamla stadsdelar', länk: 'https://www.google.com/search?q=Semana+Santa+Mallorca+2026', bild: 'https://images.unsplash.com/photo-1499678329028-101435549a02?w=1600&q=85' },
  ...
  { namn: 'Art Palma Brunch', datum: 'Hösten 2026', plats: 'Palma', kategori: 'Kultur', beskrivning: 'Internationell konstmässa i Palma med gallerier och konstnärer från hela Europa', länk: 'https://www.google.com/search?q=Art+Palma+Brunch+2026', bild: 'https://images.unsplash.com/photo-1561214115-f2f134cc4912?w=600&q=80' },
  { namn: 'La Gran Verbena', datum: 'Augusti 2026', plats: 'Palma', kategori: 'Kultur', beskrivning: 'Sommarens största folkfest med spansk musik, dans och mat under bar himmel', länk: 'https://www.google.com/search?q=Gran+Verbena+Palma+Mallorca+2026', bild: 'https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6c3?w=600&q=80' },
  ...
  { namn: 'Oktoberfest Mallorca', datum: 'Oktober 2026', plats: 'Santa Ponça & Palma', kategori: 'Kultur', beskrivning: 'Bayerskt öl, pretzel och Wiesn-stämning under Mallorcas solsken', länk: 'https://www.google.com/search?q=Oktoberfest+Mallorca+2026', bild: 'https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?w=600&q=80' },
  { namn: 'Julmarknad Palma', datum: 'December 2026', plats: 'Palma', kategori: 'Kultur', beskrivning: 'Stämningsfull julmarknad på Plaza Mayor med hantverk, julbak och glögg', länk: 'https://www.google.com/search?q=julmarknad+Palma+Mallorca+2026', bild: 'https://images.unsplash.com/photo-1512389142860-9c449e58a543?w=600&q=80' },
  { namn: 'Revetla de Sant Antoni', datum: 'Januari 2027', plats: 'Sa Pobla', kategori: 'Kultur', beskrivning: 'Mallorcas mest spektakulära eldsfestival med demoner, lägereld och djurvälsignelser', länk: 'https://www.google.com/search?q=Sant+Antoni+Festival+Mallorca+2027', bild: 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=600&q=80' },
  // MAT & DRYCK
  ...
  { namn: 'Inca Lädermässa', datum: 'November 2026', plats: 'Inca', kategori: 'Marknad', beskrivning: 'Mallorcas berömda lädermässa med skor, väskor och läderprodukter till reapriser', länk: 'https://www.google.com/search?q=Inca+Ladermarknad+Mallorca+2026', bild: 'https://images.unsplash.com/photo-1555529669-e69e7aa0ba9a?w=600&q=80' },
  ...
  // FAMILJ
  { namn: 'Fira del Ram – Nöjesfält', datum: 'April–maj 2026', plats: 'Palma', kategori: 'Familj', beskrivning: 'Mallorcas traditionella nöjesfält med karuseller, spel och sötsaker för hela familjen', länk: 'https://www.google.com/search?q=Fira+del+Ram+Palma+Mallorca+2026', bild: 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=600&q=80' },
  { namn: 'Aqualand El Arenal – Säsongsöppning', datum: 'Maj 2026', plats: 'El Arenal', kategori: 'Familj', beskrivning: 'Mallorcas populäraste vattenpark öppnar för sommarsäsongen med nya attraktioner', länk: 'https://www.aqualand.es', bild: 'https://images.unsplash.com/photo-1530549387789-4c1017266635?w=600&q=80' },
  { namn: 'Coves del Drach – Sommarsäsong', datum: 'April–oktober 2026', plats: 'Porto Cristo', kategori: 'Familj', beskrivning: 'Dramatiska underjordiska grottor med konsert på världens största underjordiska sjö', länk: 'https://www.google.com/search?q=Coves+del+Drach+Mallorca', bild: 'https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=1600&q=85' },
  { namn: 'Safari Zoo Porto Cristo', datum: 'Hela sommaren 2026', plats: 'Porto Cristo', kategori: 'Familj', beskrivning: 'Mallorcas populäraste djurpark med giraffer, lejon, elefanter och kamelridning', länk: 'https://www.google.com/search?q=Safari+Zoo+Porto+Cristo+Mallorca', bild: 'https://images.unsplash.com/photo-1504450758481-7338eba7524a?w=600&q=80' },
  { namn: 'Hidropark Alcúdia', datum: 'Juni–september 2026', plats: 'Alcúdia', kategori: 'Familj', beskrivning: 'Populär vattenpark norr om Alcúdia med vattenrutschkanor och barnpooler', länk: 'https://www.hidropark.com', bild: 'https://images.unsplash.com/photo-1530549387789-4c1017266635?w=600&q=80' },
  { namn: 'Palma Aquarium', datum: 'Hela året', plats: 'Palma', kategori: 'Familj', beskrivning: 'Ett av Europas mest imponerande akvarium med hajbassäng och tropiska rev', länk: 'https://www.palmaaquarium.com', bild: 'https://images.unsplash.com/photo-1504194104404-433180773017?w=600&q=80' },
  { namn: 'Marineland Mallorca', datum: 'Maj–oktober 2026', plats: 'Costa de Blanes', kategori: 'Familj', beskrivning: 'Delfinshow, pingviner och hajar – perfekt familjedag längs sydvästkusten', länk: 'https://www.marineland.es', bild: 'https://images.unsplash.com/photo-1504194104404-433180773017?w=600&q=80' },
  { namn: 'Coves d\'Artà', datum: 'April–oktober 2026', plats: 'Capdepera', kategori: 'Familj', beskrivning: 'Dramatiska grottor med stalaktiter och stalagmiter nära Mallorcas nordliga udde', länk: 'https://www.google.com/search?q=Coves+Arta+Mallorca', bild: 'https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=1600&q=85' },
  { namn: 'Western Park Mallorca', datum: 'Sommaren 2026', plats: 'Magaluf', kategori: 'Familj', beskrivning: 'Vilda västern-tema med vattenrutschkanor, barnaktiviteter och western-shower', länk: 'https://www.westernpark.com', bild: 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=600&q=80' },
  { namn: 'Falconeria de Altair', datum: 'Hela sommaren 2026', plats: 'Cas Concos', kategori: 'Familj', beskrivning: 'Spektakulärt falkneri med örnar, falkar och ugglor – unikt för barn och vuxna', länk: 'https://www.google.com/search?q=Falconeria+de+Altair+Mallorca', bild: 'https://images.unsplash.com/photo-1504450758481-7338eba7524a?w=600&q=80' },
];

export default function SectionEvents() {
  return (
    <section className="page-section" style={{ background: '#eeede4' }}>
            ...
            {evenemang.slice(0, 6).map((e, i) => (
              <div key={i} style={{ background: 'white', borderRadius: '12px', overflow: 'hidden', boxShadow: '0 2px 12px rgba(0,0,0,0.08)' }}>
                <div style={{ position: 'relative' }}>
                  ...
                  <div style={{ position: 'absolute', top: '8px', left: '8px', background: '#F59E0B', color: '#383a46', padding: '3px 8px', borderRadius: '8px', fontSize: '0.7rem', fontWeight: '700' }}>
                    {e.kategori}
                  </div>
                </div>
                <div style={{ padding: '14px' }}>
                  ...
                  <a href={e.länk} target="_blank" rel="noopener noreferrer" style={{ display: 'block', textAlign: 'center', padding: '7px', background: '#F59E0B', color: '#383a46', borderRadius: '6px', textDecoration: 'none', fontSize: '0.8rem', fontWeight: '600' }}>
                    Läs mer →
                  </a>
                </div>
              </div>
            ...
            {evenemang.slice(0, 6).map((e, i) => (
              <div key={i} className="events-mobile-card">
                <div style={{ position: 'relative' }}>
                  ...
                  <div style={{ position: 'absolute', top: '10px', left: '10px', background: '#F59E0B', color: '#383a46', padding: '4px 10px', borderRadius: '8px', fontSize: '0.7rem', fontWeight: '700' }}>
                    {e.kategori}
                  </div>
                </div>
                <div style={{ padding: '16px' }}>
                  <p style={{ fontSize: '0.78rem', color: '#993335', fontWeight: '600', margin: '0 0 6px', letterSpacing: '0.03em' }}>
                    <IconCalendar size={12} style={{ verticalAlign: '-2px', marginRight: 4 }} /> {e.datum}
                  </p>
                  <h3 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.15rem', letterSpacing: '0.05em', margin: '0 0 8px', color: '#383a46', lineHeight: 1.2 }}>
                    {e.namn}
                  </h3>
                  ...
                  <a href={e.länk} target="_blank" rel="noopener noreferrer" style={{ display: 'block', textAlign: 'center', padding: '10px', background: '#F59E0B', color: '#383a46', borderRadius: '8px', textDecoration: 'none', fontSize: '0.85rem', fontWeight: '700', letterSpacing: '0.05em' }}>
                    LÄS MER →
                  </a>
                </div>
              </div>
