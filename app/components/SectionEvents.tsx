...
export const evenemang = [
  ...
  { namn: 'Palma Aquarium', datum: 'Hela året', plats: 'Palma', kategori: 'Familj', beskrivning: 'Ett av Europas mest imponerande akvarium med hajbassäng och tropiska rev', länk: 'https://www.palmaaquarium.com', bild: 'https://images.unsplash.com/photo-1559827291-72ee739d0d9a?w=600&q=80' },
  { namn: 'Marineland Mallorca', datum: 'Maj–oktober 2026', plats: 'Costa de Blanes', kategori: 'Familj', beskrivning: 'Delfinshow, pingviner och hajar – perfekt familjedag längs sydvästkusten', länk: 'https://www.marineland.es', bild: 'https://images.unsplash.com/photo-1559827291-72ee739d0d9a?w=600&q=80' },
