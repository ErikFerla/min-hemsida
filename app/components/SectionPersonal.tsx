      ...
      <div className={styles.personalInner}>
        ...
        <div className={`${styles.personalGrid} personal-mobile-scroll`}>
          <div className={`${styles.personalCard} personal-mobile-card`}>
            <span className={styles.personalEmoji} style={{ color: '#383a46', display: 'inline-flex', alignItems: 'center' }}><IconWave size={26} /></span>
          ...
          <div className={`${styles.personalCard} personal-mobile-card`}>
            <span className={styles.personalEmoji} style={{ color: '#383a46', display: 'inline-flex', alignItems: 'center' }}><IconForkKnife size={26} /></span>
          ...
          <div className={`${styles.personalCard} personal-mobile-card`}>
            <span className={styles.personalEmoji} style={{ color: '#383a46', display: 'inline-flex', alignItems: 'center' }}><IconSparkle size={26} /></span>
            <h3>Gömda pärlan</h3>
