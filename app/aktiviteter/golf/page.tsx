...
const golfbanor = [
  ...
  { namn: 'Club de Golf Canyamel', plats: 'Canyamel', region: 'Öst', hål: 18, svårighet: 'Medel', pris: '💰💰💰', beskrivning: 'Vacker bana i östra Mallorca nära Canyamel med tallskog och buskvegetation. Vattenhinder och doglegs.', bild: 'https://images.unsplash.com/photo-1587174486073-ae5e5cff23aa?w=600&q=80', maps: 'https://maps.google.com/?q=Club+de+Golf+Canyamel+Mallorca', webb: 'https://www.canyamelgolf.com', tips: "Nära Coves d'Artà – perfekt att kombinera utflykt och golf" },
];
