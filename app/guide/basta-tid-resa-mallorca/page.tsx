    ...
    <div style={{ background: '#FDF8F2', minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: '860px', margin: '0 auto', padding: 'clamp(40px,6vw,80px) clamp(16px,4vw,40px)' }}>
        ...
        <div style={{ background: '#F0EBE3', borderRadius: '16px', padding: '24px 28px', marginBottom: '48px', borderLeft: '4px solid #F59E0B' }}>
          <p style={{ fontWeight: '700', color: '#1F2937', marginBottom: '12px', fontSize: '1rem', display: 'inline-flex', alignItems: 'center', gap: 8 }}><IconSparkle size={18} /> Vad söker du? → Vår rekommendation</p>
        ...
        <div style={{ background: '#EDE4D8', borderRadius: '20px', padding: '32px', marginBottom: '48px', borderLeft: '4px solid #F59E0B' }}>
          <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.8rem', letterSpacing: '0.05em', color: '#1F2937', margin: '0 0 12px', display: 'inline-flex', alignItems: 'center', gap: 10 }}><IconSparkle size={22} /> Hemligheten: Åk i september</h2>
