...
export default function Sineu() {
  return (
    <div style={{ background: '#fefefb', minHeight: '100vh' }}>
      ...
      {/* TODO: hero photo reused across multiple towns — replace with Sineu-specific (Sa Plaça / onsdagsmarknaden) */}
      <HeroImage
        src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e"
        alt="Marknadstorget i Sineu – Mallorcas geografiska hjärta med öns äldsta marknad"
        kicker="Centrala Mallorca · Inland"
        title="Sineu"
        subtitle="Mallorcas geografiska hjärta med öns äldsta marknad – sedan kung Jaume II år 1306"
      />
        ...
        <div className="city-grid">
          <div>
            ...
            <div style={{ marginTop: '32px', marginBottom: '32px' }}>
              <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.8rem', letterSpacing: '0.05em', marginBottom: '20px', color: '#383a46' }}>Topp 3 i Sineu</h2>
              {[
                { Icon: IconStar, text: 'Onsdagsmarknaden – öns äldsta marknad sedan 1306, kom tidigt' },
                { Icon: IconBuilding, text: 'Sa Placa-torget – hjärtat av byn med caféer och äkta mallorcansk stämning' },
                { Icon: IconPin, text: 'Kyrkan Mare de Déu dels Àngels – imponerande gotisk katedral mitt i byn' },
              ].map((item, i) => (
