...
export default function Arta() {
  return (
    <div style={{ background: '#fefefb', minHeight: '100vh' }}>
      ...
      {/* TODO: hero photo reused across multiple towns — replace with Artà-specific (Santuari de Sant Salvador) */}
      <HeroImage
        src="https://images.unsplash.com/photo-1569231413036-dacdb2cfb7ec"
        alt="Medeltida bergsstad Artà i östra Mallorca med stensatta gränder"
        kicker="Östra Mallorca · Levant"
        title="Artà"
        subtitle="Historisk bergsstad med imponerande medeltida borg och vackra stensatta gränder"
      />
