...
export default function Alcudia() {
  return (
    <div style={{ background: '#fefefb', minHeight: '100vh' }}>
      ...
      {/* TODO: hero photo reused across multiple towns — replace with Alcúdia-specific (medeltida stadsmurar / romerska Pollentia) */}
      <HeroImage
        src="https://images.unsplash.com/photo-1566815687825-39bd872e6e09"
        alt="Medeltida stadsmurar i Alcúdia – norra Mallorcas historiska kuststad"
        kicker="Norra Mallorca · Historisk kuststad"
        title="Alcúdia"
        subtitle="En av Mallorcas bäst bevarade medeltida städer med imponerande stadsmurer och romersk teater"
      />
