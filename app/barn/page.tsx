...
const kategorier = [
  {
    ...
    aktiviteter: [
      ...
      { namn: 'Western Water Park', plats: 'Magaluf', ålder: 'Alla åldrar', tips: 'Kombinera med Western Park-temat', bild: 'https://images.unsplash.com/photo-1530549387789-4c1017266635?w=600&q=80', lat: 39.5012, lon: 2.5189, webb: 'https://www.westernpark.com' },
      { namn: 'Aqualand Magaluf', plats: 'Magaluf', ålder: 'Alla åldrar', tips: 'Europas längsta rutschbana finns här', bild: 'https://images.unsplash.com/photo-1530549387789-4c1017266635?w=600&q=80', lat: 39.5012, lon: 2.5234, webb: 'https://www.aqualand.es' },
      { namn: 'Marineland Vattenpark', plats: 'Costa de Blanes', ålder: 'Alla åldrar', tips: 'Kombinera med djurshowerna på samma anläggning', bild: 'https://images.unsplash.com/photo-1530549387789-4c1017266635?w=600&q=80', lat: 39.5678, lon: 2.5123, webb: 'https://www.marineland.es' },
    ],
  },
  {
    ...
    aktiviteter: [
      ...
      { namn: 'Natura Parc', plats: 'Santa Eugènia', ålder: 'Alla åldrar', tips: 'Ekologisk djurpark med inhemska djur – unikt på ön', bild: 'https://images.unsplash.com/photo-1559827291-72ee739d0d9a?w=600&q=80', lat: 39.6234, lon: 2.8456, webb: 'https://www.naturaparc.net' },
      { namn: 'Falconeria de Altair', plats: 'Cas Concos', ålder: '3+ år', tips: 'Dagliga uppvisningar med örnar, falkar och ugglor', bild: 'https://images.unsplash.com/photo-1559827291-72ee739d0d9a?w=600&q=80', lat: 39.4123, lon: 3.1456, webb: 'https://www.google.com/search?q=Falconeria+Altair+Mallorca' },
    ],
  },
  {
    ...
    aktiviteter: [
      ...
      { namn: "Glassbottenbåt Cala d'Or", plats: "Cala d'Or", ålder: 'Alla åldrar', tips: 'Se undervattenslivet utan att blöta ner dig', bild: 'https://images.unsplash.com/photo-1540946485063-a40da27545f8?w=600&q=80', lat: 39.3789, lon: 3.2345, webb: 'https://www.google.com/search?q=glassbottenbat+Cala+dOr+Mallorca' },
    ],
  },
  {
  ...
  },
  {
    ...
    aktiviteter: [
      ...
      { namn: 'Crazy Golf Alcúdia', plats: 'Alcúdia', ålder: 'Alla åldrar', tips: 'Rolig kvällsaktivitet efter en dag på stranden', bild: 'https://images.unsplash.com/photo-1535131749006-b7f58c99034b?w=600&q=80', lat: 39.8234, lon: 3.1234, webb: 'https://www.google.com/search?q=crazy+golf+Alcudia+Mallorca' },
    ...
    <div style={{ background: '#e8e8e8', minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '60px 60px' }}>
              ...
              {kategori.aktiviteter.map((a) => (
                <div key={a.namn} style={{
                  ...
                  <div style={{ padding: '16px' }}>
                    <h3 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.2rem', margin: '0 0 6px', color: '#111' }}>{a.namn}</h3>
                    <p style={{ fontSize: '0.82rem', color: '#888', margin: '0 0 2px' }}>📍 {a.plats}</p>
                    <p style={{ fontSize: '0.82rem', color: '#888', margin: '0 0 10px' }}>👶 {a.ålder}</p>
                    <div style={{ fontSize: '0.82rem', color: '#555', background: '#f5f5f5', padding: '8px 10px', borderRadius: '8px', marginBottom: '14px', lineHeight: '1.5' }}>
                      💡 {a.tips}
                    </div>
                    <div style={{ display: 'flex', gap: '8px' }}>
                      <a href={`https://www.google.com/maps?q=${a.lat},${a.lon}`} target="_blank" rel="noopener noreferrer"
                        style={{ flex: 1, textAlign: 'center', padding: '9px', background: '#111', color: 'white', fontSize: '0.82rem', borderRadius: '8px', textDecoration: 'none', fontWeight: '600' }}>
                        🗺️ Karta
                      </a>
                      <a href={a.webb} target="_blank" rel="noopener noreferrer"
                        style={{ flex: 1, textAlign: 'center', padding: '9px', background: 'white', color: '#111', border: '2px solid #111', fontSize: '0.82rem', borderRadius: '8px', textDecoration: 'none', fontWeight: '600' }}>
                        🌐 Hemsida
                      </a>
                    </div>
                  </div>
        ...
        <section style={{ marginTop: '20px' }}>
          <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '2.2rem', letterSpacing: '0.05em', color: '#111', marginBottom: '24px', paddingBottom: '12px', borderBottom: '3px solid #c0392b' }}>
