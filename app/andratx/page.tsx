...
export default function Andratx() {
  return (
    <div style={{ background: '#fefefb', minHeight: '100vh' }}>
      ...
      {/* TODO: hero photo reused across multiple towns — replace with Andratx-specific (Port d'Andratx marina) */}
      <HeroImage
        src="https://images.unsplash.com/photo-1566815687825-39bd872e6e09"
        alt="Lugn stadskärna i Andratx i sydvästra Mallorca med Tramuntana-bergen i bakgrunden"
        kicker="Sydvästra Mallorca · Tramuntana"
        title="Andratx"
        subtitle="Lugn stadskärna i sydväst med exklusiv marina och dramatisk bergskuliss"
      />
