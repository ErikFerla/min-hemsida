...
export default function Valldemossa() {
  return (
    <div style={{ background: '#fefefb', minHeight: '100vh' }}>
      ...
      {/* TODO: hero photo is a generic Tramuntana image shared with Deià/Pollença/Artà — replace with Valldemossa-specific (klostret / ockrafärgade fasader) */}
      <HeroImage
        src="https://images.unsplash.com/photo-1569231413036-dacdb2cfb7ec"
        alt="Stenbelagda gränder i Valldemossa – UNESCO-skyddad bergsby i Serra de Tramuntana"
        kicker="Nordvästra Mallorca · Tramuntana"
        title="Valldemossa"
        subtitle="UNESCO-skyddad bergsby känd för Chopins vistelse och det magnifika kartusianerklostret"
      />
        ...
        <div className="city-grid">
          <div>
            ...
            <div style={{ marginTop: '32px', marginBottom: '32px' }}>
              <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.8rem', letterSpacing: '0.05em', marginBottom: '20px', color: '#383a46' }}>Topp 3 i Valldemossa</h2>
              {[
