...
export default function Deia() {
  return (
    <div style={{ background: '#fefefb', minHeight: '100vh' }}>
      ...
      {/* TODO: hero photo is a generic Tramuntana image shared with other bergsbyar — replace with Deià-specific (husen i bergssluttningen / Cala Deià) */}
      <HeroImage
        src="https://images.unsplash.com/photo-1569231413036-dacdb2cfb7ec"
        alt="Bohemisk konstnärsby Deià inbyggd i Tramuntanabergens sluttning med havsutsikt"
        kicker="Nordvästra Mallorca · Tramuntana"
        title="Deià"
        subtitle="Bohemisk konstnärsby i Tramuntana-bergen med havsutsikt och Robert Graves arv"
      />
        ...
        <div className="city-grid">
          <div>
            ...
            <div style={{ marginTop: '32px', marginBottom: '32px' }}>
              <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.8rem', letterSpacing: '0.05em', marginBottom: '20px', color: '#383a46' }}>Topp 3 i Deià</h2>
              {[
                { Icon: IconStar, text: 'Robert Graves museum – hem och arbetsstugan för den berömde poeten' },
                { Icon: IconBuilding, text: 'Cala Deià – en av öns vackraste klippbadplatser, orört och fridfullt' },
                { Icon: IconPin, text: 'Utsikten från kyrkan – panorama över bergen och Medelhavet' },
              ].map((item, i) => (
