    ...
    <div style={{ background: '#e8e8e8', minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: 'clamp(24px,4vw,60px) clamp(16px,4vw,40px)' }}>
        ...
        <div style={{ background: 'white', borderRadius: '20px', padding: '40px', boxShadow: '0 4px 24px rgba(0,0,0,0.1)', marginBottom: '48px' }}>
          ...
          <button
            onClick={sökFlyg}
            style={{ width: '100%', padding: '16px', background: '#c0392b', color: 'white', border: 'none', borderRadius: '10px', fontSize: '1.1rem', fontFamily: '"Bebas Neue", sans-serif', letterSpacing: '0.1em', cursor: 'pointer' }}
          >
          ...
          {flygplatser.map(f => (
            <div key={f.kod} style={{ background: 'white', borderRadius: '16px', padding: '24px', boxShadow: '0 2px 12px rgba(0,0,0,0.08)' }}>
              ...
              <button
                ...
                style={{ width: '100%', padding: '10px', background: '#111', color: 'white', border: 'none', borderRadius: '8px', fontSize: '0.9rem', fontWeight: '600', cursor: 'pointer' }}
              >
                Sök flyg →
              </button>
            </div>
